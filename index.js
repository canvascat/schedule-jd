...
// Key 单引号内自行填写您抓取的Cookie
// DualKey 如需双账号签到,此处单引号内填写抓取的"账号2"Cookie, 否则请勿填写
const [Key, serverSecret, DualKey = ''] = process.argv.slice(2);

if (!Key) throw new Error('cookie 读取失败');
